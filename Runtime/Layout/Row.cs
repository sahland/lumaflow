...
namespace LumaFlow {
    ...
    /// <summary>
    /// Arranges child widgets horizontally using native UI Toolkit flex layout.
    /// </summary>
    public sealed class Row : Widget {
        ...
        public Row(
            ...
            for (var index = 0; index < children.Count; index++) {
                _children[index] = children[index] ?? throw new ArgumentException(
                    "Row children cannot contain null.",
                    nameof(children));
            }
        ...
        /// <summary>
        /// Gets the widgets arranged by this row.
        /// </summary>
        public IReadOnlyList<Widget> Children => _children;

        /// <summary>
        /// Gets the gap between adjacent children.
        /// </summary>
